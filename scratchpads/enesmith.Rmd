...
allegations_2016 <- allegations_2016 %>% 
  replace_na(list(complainant_ethnicity = 'NA', complainant_gender = 'NA', complainant_age_incident = 'NA'))
...
comp_race_2018 <- allegations_2018 %>%
  ...
  plot_ly(x = ~complainant_ethnicity,
          ...
          text = ~percent,
          textposition = 'auto') %>% 
  layout(title = "Racial Percentages of 2281 Complainants in 2016 Allegations",
         xaxis = list(title = 'Race of Complainants'),
         yaxis = list(title = 'Number of Complaints'))
